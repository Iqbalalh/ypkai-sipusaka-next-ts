  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* PERUBAHAN UTAMA: Mengganti Link dengan Button dan menambahkan onClick */}
        <button
          onClick={handleSignOut} // Panggil fungsi signOut
        ...
        >
          ...
          >
            <path
              ...
              fill="currentColor" // Menggunakan currentColor agar bisa mengikuti warna group-hover
            />
          </svg>
          Sign out
        </button>
